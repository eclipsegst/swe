      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url();?>add_ta"> Add a TA </a></li>
            <li><a href="<?php echo base_url();?>create"> Create an assignment </a></li>
            <li><a href="<?php echo base_url();?>assignment_list"> List of submission </a></li>
          </ul>
